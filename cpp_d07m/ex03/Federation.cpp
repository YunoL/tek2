...
void	Federation::Starfleet::Ship::setShield(int value)
{
	this->_shield = value;
}
...
void	Federation::Starfleet::Ship::fire(int torpedoes, Borg::Ship*	ennemy)
{
	if (torpedoes <= this->_photonTorpedo)
	{
		ennemy->setShield(ennemy->getShield() - 50 * torpedoes);
...
void	Federation::Starfleet::Ship::fire(Borg::Ship*	ennemy)
{
	fire(1, ennemy);
}
